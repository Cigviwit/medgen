...
import { FileDown, CheckCircle2, FileText, BookOpen, ClipboardCheck } from "lucide-react";
...
const ResultDisplay = ({ results }: ResultDisplayProps) => {
  ...
  const [mode, setMode] = useState<"browse" | "practice" | "test">("browse");
    ...
    <Card className="w-full medical-glass animate-slide-up">
      ...
      <CardContent className="space-y-4">
        <div className="flex flex-col sm:flex-row gap-3 justify-between items-start sm:items-center">
          <ToggleGroup type="single" value={mode} onValueChange={(value) => value && setMode(value as "browse" | "practice" | "test")} className="justify-start">
            ...
            <ToggleGroupItem value="test" aria-label="Test Mode">
        ...
        {mode === "browse" ? (
          ...
          <QuizMode 
            results={results} 
            mode={mode} 
            activeSubtopic={activeTab}
            onChangeSubtopic={setActiveTab}
          />
        )}
      </CardContent>
    </Card>
